<?php
class Application_View_Helper_FormDate extends Zend_View_Helper_FormElement
{
	...
	public function formDate($name, $value = null, $attribs = null) {
		...
		$dayAttribs = isset($attribs['dayAttribs']) ? $attribs['dayAttribs']
				: array();

		$monthAttribs = isset($attribs['monthAttribs']) ? $attribs['monthAttribs']
				: array();

		$yearAttribs = isset($attribs['yearAttribs']) ? $attribs['yearAttribs']
				: array();
		...
		for ($i = 1; $i < 13; $i++) {
			...
			$monthMultiOptions[$index] = date('F',
					mktime(null, null, null, $i, 01));
		...
		return $this->view
				->formSelect($name . '[day]', $day, $dayAttribs,
						$dayMultiOptions) . '&nbsp;'
				. $this->view
						->formSelect($name . '[month]', $month, $monthAttribs,
								$monthMultiOptions) . '&nbsp;'
				. $this->view
						->formSelect($name . '[year]', $year, $yearAttribs,
								$yearMultiOptions
						);
